...
def contracts_client(
    ...
    factory = algorand_client.client.get_typed_app_factory(
        ContractsFactory, default_sender=deployer.address
    )
...
def test_says_hello(contracts_client: ContractsClient) -> None:
    result = contracts_client.send.hello(args=("World",))
